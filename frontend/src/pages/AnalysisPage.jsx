...
export default function AnalysisPage() {
  ...
  return (
    <div className="flex min-h-screen bg-white dark:bg-gray-900">
      <Sidebar />
      <main className="flex-1 md:ml-40 flex flex-col items-center justify-center p-4 md:p-8 pb-20 md:pb-8 gap-6">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 w-full max-w-5xl">
          <div className="flex gap-3">
            <div
              className="rounded-full overflow-hidden border border-gray-400 dark:border-gray-600 flex flex-col"
              style={{ width: 28, height: boardWidth }}
            >
              <div
